...
func main() {
	...
	request := nativedto.UpdateDerivativeOrderRequest{UpdateDerivativeOrderBody: nativedto.UpdateDerivativeOrderBody{AccountID: mustEnv("TCBS_ACCOUNT_ID"), Nprice: mustFloatEnv("TCBS_NEW_PRICE"), Nvol: mustFloatEnv("TCBS_NEW_VOLUME"), OrderNo: mustEnv("TCBS_ORDER_NO"), RefID: mustEnv("TCBS_REF_ID"), SubAccountID: mustEnv("TCBS_SUB_ACCOUNT_ID")}}
