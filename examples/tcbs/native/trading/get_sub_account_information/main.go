...
func main() {
	...
	request := nativedto.GetSubAccountInformationRequest{CustodyCode: mustEnv("TCBS_CUSTODY_CODE"), Fields: envDefault("TCBS_FIELDS", "basicInfo,personalInfo,bankAccounts,bankSubAccounts")}
