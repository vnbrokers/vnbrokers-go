...
func main() {
	...
	request := nativedto.GetDerivativeCashRequest{AccountID: mustEnv("TCBS_ACCOUNT_ID"), SubAccountID: mustEnv("TCBS_SUB_ACCOUNT_ID"), GetType: envDefault("TCBS_GET_TYPE", "ALL")}
