...
func main() {
	...
	request := nativedto.PlaceStockOrderRequest{AccountNo: mustEnv("TCBS_ACCOUNT_NO"), PlaceStockOrderBody: nativedto.PlaceStockOrderBody{ExecType: envDefault("TCBS_EXEC_TYPE", "NB"), Price: mustIntEnv("TCBS_PRICE"), PriceType: envDefault("TCBS_PRICE_TYPE", "LO"), Quantity: mustIntEnv("TCBS_QUANTITY"), Symbol: mustEnv("TCBS_SYMBOL")}}
