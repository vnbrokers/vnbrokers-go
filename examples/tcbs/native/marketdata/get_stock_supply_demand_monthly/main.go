...
func main() {
	...
	request := nativedto.GetStockSupplyDemandMonthlyRequest{Ticker: envDefault("TCBS_TICKER", "TCBS"), TimeWindow: envDefault("TCBS_TIME_WINDOW", "1M"), Type: envDefault("TCBS_TYPE", "stock")}
