...
func main() {
	...
	request := nativedto.GetCashStatementsRequest{AccountNo: mustEnv("TCBS_ACCOUNT_NO"), FromDate: mustEnv("TCBS_FROM_DATE"), ToDate: mustEnv("TCBS_TO_DATE"), PageSize: envDefault("TCBS_PAGE_SIZE", "20"), PageIndex: envDefault("TCBS_PAGE_INDEX", "0"), TransactionCode: os.Getenv("TCBS_TRANSACTION_CODE")}
