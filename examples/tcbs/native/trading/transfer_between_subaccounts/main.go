...
func main() {
	...
	request := nativedto.TransferBetweenSubaccountsRequest{TransferBetweenSubaccountsBody: nativedto.TransferBetweenSubaccountsBody{Amount: mustFloatEnv("TCBS_AMOUNT"), Description: mustFloatEnv("TCBS_DESCRIPTION"), DestinationAccountNumber: mustEnv("TCBS_DESTINATION_ACCOUNT_NO"), SourceAccountNumber: mustEnv("TCBS_SOURCE_ACCOUNT_NO")}}
