...
func main() {
	...
	request := nativedto.GetStockTradeHistoryRequest{Ticker: envDefault("TCBS_TICKER", "TCBS"), Page: envFloat("TCBS_PAGE", 0), Size: envFloat("TCBS_SIZE", 20), HeadIndex: envFloat("TCBS_HEAD_INDEX", 0)}
