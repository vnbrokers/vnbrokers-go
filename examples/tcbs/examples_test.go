...
func TestNativeExampleCoverage(t *testing.T) {
	...
	examples := map[string]string{
		...
		"SubscribeBidPrices":                       "native/marketdata/realtime/subscribe_bid_prices",
		"SubscribeOfferPrices":                     "native/marketdata/realtime/subscribe_offer_prices",
		"SubscribeForeignTrading":                  "native/marketdata/realtime/subscribe_foreign_trading",
		"SubscribeBasePrices":                      "native/marketdata/realtime/subscribe_base_prices",
		"SubscribeMatchedPrices":                   "native/marketdata/realtime/subscribe_matched_prices",
		"SubscribeTickerMatches":                   "native/marketdata/realtime/subscribe_ticker_matches",
		"SubscribeMarketIndexes":                   "native/marketdata/realtime/subscribe_market_indexes",
		"SubscribePutThroughAdvertisements":        "native/marketdata/realtime/subscribe_put_through_advertisements",
		"SubscribePutThroughMatches":               "native/marketdata/realtime/subscribe_put_through_matches",
		"SubscribeRawEvent":                        "native/marketdata/realtime/subscribe_raw_event",
	}
