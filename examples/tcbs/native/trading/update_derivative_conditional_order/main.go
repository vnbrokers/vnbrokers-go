...
func main() {
	...
	request := nativedto.UpdateDerivativeConditionalOrderRequest{UpdateDerivativeConditionalOrderBody: nativedto.UpdateDerivativeConditionalOrderBody{AccountID: mustEnv("TCBS_ACCOUNT_ID"), Cmd: mustEnv("TCBS_CMD"), PkOrderNo: mustEnv("TCBS_PK_ORDER_NO"), RefID: mustEnv("TCBS_REF_ID"), SoPrice: mustFloatEnv("TCBS_SO_PRICE"), Type: mustEnv("TCBS_TYPE")}}
