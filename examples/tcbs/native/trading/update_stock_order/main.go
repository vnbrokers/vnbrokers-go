...
func main() {
	...
	request := nativedto.UpdateStockOrderRequest{AccountNo: mustEnv("TCBS_ACCOUNT_NO"), OrderID: mustEnv("TCBS_ORDER_ID"), UpdateStockOrderBody: nativedto.UpdateStockOrderBody{Price: mustIntEnv("TCBS_PRICE"), Quantity: mustIntEnv("TCBS_QUANTITY")}}
