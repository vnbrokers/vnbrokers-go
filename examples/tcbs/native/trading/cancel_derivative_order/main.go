...
func main() {
	...
	request := nativedto.CancelDerivativeOrderRequest{CancelDerivativeOrderBody: nativedto.CancelDerivativeOrderBody{AccountID: mustEnv("TCBS_ACCOUNT_ID"), Cmd: mustEnv("TCBS_CMD"), OrderNo: mustEnv("TCBS_ORDER_NO"), Pin: mustEnv("TCBS_PIN"), RefID: mustEnv("TCBS_REF_ID")}}
