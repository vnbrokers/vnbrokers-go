...
func main() {
	...
	request := nativedto.GetStockSupplyDemand15MinutesRequest{Ticker: envDefault("TCBS_TICKER", "TCBS"), TimeWindow: envDefault("TCBS_TIME_WINDOW", "15m"), TWindow: envDefault("TCBS_T_WINDOW", "15m"), Type: envDefault("TCBS_TYPE", "stock")}
