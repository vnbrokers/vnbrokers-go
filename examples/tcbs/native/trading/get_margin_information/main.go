...
func main() {
	...
	request := nativedto.GetMarginInformationRequest{AccountNo: mustEnv("TCBS_ACCOUNT_NO"), FromDate: mustEnv("TCBS_FROM_DATE"), ToDate: mustEnv("TCBS_TO_DATE"), Page: envDefault("TCBS_PAGE", "0"), Size: envDefault("TCBS_SIZE", "20"), CustodyCode: mustEnv("TCBS_CUSTODY_CODE")}
