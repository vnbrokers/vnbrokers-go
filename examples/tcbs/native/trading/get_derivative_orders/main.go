...
func main() {
	...
	request := nativedto.GetDerivativeOrdersRequest{PageNo: envFloat("TCBS_PAGE_NO", 0), PageSize: envFloat("TCBS_PAGE_SIZE", 20), AccountID: mustEnv("TCBS_ACCOUNT_ID"), Symbol: os.Getenv("TCBS_SYMBOL"), RefID: os.Getenv("TCBS_REF_ID"), OrderType: os.Getenv("TCBS_ORDER_TYPE"), Status: os.Getenv("TCBS_STATUS")}
