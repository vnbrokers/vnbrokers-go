...
func main() {
	...
	request := nativedto.DepositDerivativeMarginRequest{DepositDerivativeMarginBody: nativedto.DepositDerivativeMarginBody{AccountID: mustEnv("TCBS_ACCOUNT_ID"), Amount: mustFloatEnv("TCBS_AMOUNT"), PaymentContent: mustFloatEnv("TCBS_PAYMENT_CONTENT"), SubAccountID: mustEnv("TCBS_SUB_ACCOUNT_ID")}}
